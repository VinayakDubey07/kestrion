...
2. **MCP Server**: Expose a Kestrion `Agent` as a real MCP server so that external clients (e.g. Claude Code) can invoke it. See [`examples/mcp_server.py`](https://github.com/VinayakDubey07/kestrion/blob/main/examples/mcp_server.py) and [`tests/unit/test_mcp_server.py`](https://github.com/VinayakDubey07/kestrion/blob/main/tests/unit/test_mcp_server.py).
